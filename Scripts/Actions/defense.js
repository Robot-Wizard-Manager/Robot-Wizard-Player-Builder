 function addDefenceActions(){
    ...
    (stats,element)=>{
        var base = parseInt(25 * getMuliOfTwo(stats.defense,50,getElementValue(element,stats),50));
    ...
    (stats,element)=>{
        var base = parseInt(100 * getMuliOfTwo(stats.defense,50,getElementValue(element,stats),50));
        var strong =parseInt( base * 1.5);
        var weak = parseInt(base * .5);
        var cost = 80;
        return `Mana Cost ${cost}\n`+
